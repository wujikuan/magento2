...
class AlipayCheckoutConfigProvider implements ConfigProviderInterface
{
    /**
     * @var string[]
     */
    protected $methodCode = Alipay::PAYMENT_METHOD_CHECKMO_CODE;
            ...
            'payment' => [
                'alipay' => [
                    ...
                    'config' =>array (
                        ...
                        //同步跳转
                        'return_url' => "http://localhost/alipay.trade.page.pay-PHP-UTF-8/return_url.php",

...
namespace Zou\BannerSlider\Model\ResourceModel;
...
/**
 * Class Slider
 * @package Zou\BannerSlider\Model\ResourceModel
 */
class Slider extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->sliderBannerTable = $this->getTable('zou_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('zou_bannerslider_slider', 'slider_id');
    }
     ...
     * after save callback
     *
     * @param AbstractModel|\Zou\BannerSlider\Model\Slider $object
     *
     * @return AbstractDb
     */
    ...
    /**
     * @param \Zou\BannerSlider\Model\Slider $slider
     *
     * @return array
     */
    public function getBannersPosition(\Zou\BannerSlider\Model\Slider $slider)
    {
     ...
     * @return $this
     */
    protected function saveBannerRelation(\Zou\BannerSlider\Model\Slider $slider)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'zou_bannerslider_slider_after_save_banners',

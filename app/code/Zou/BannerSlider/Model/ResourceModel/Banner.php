...
class Banner extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->bannerSliderTable = $this->getTable('zou_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('zou_bannerslider_banner', 'banner_id');
    }
    ...
    /**
     * @param \Zou\BannerSlider\Model\Banner $banner
     *
     * @return $this
     */
    protected function saveSliderRelation(\Zou\BannerSlider\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'zou_bannerslider_banner_after_save_sliders',
     ...
     * @return array
     */
    public function getSliderIds(\Zou\BannerSlider\Model\Banner $banner)
    {
        $adapter = $this->getConnection();
        $select  = $adapter->select()

...
use Zou\BannerSlider\Model\Config\Source\Image as configImage;
use Zou\BannerSlider\Model\ResourceModel\Banner as ResourceBanner;
use Zou\BannerSlider\Model\ResourceModel\Slider\Collection;
use Zou\BannerSlider\Model\ResourceModel\Slider\CollectionFactory as sliderCollectionFactory;
...
class Banner extends AbstractModel implements IdentityInterface
{
     ...
     * @var string
     */
    const CACHE_TAG = 'zou_bannerslider_banner';
     ...
     * @var string
     */
    protected $_cacheTag = 'zou_bannerslider_banner';
     ...
     * @var string
     */
    protected $_eventPrefix = 'zou_bannerslider_banner';

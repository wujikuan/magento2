...
namespace Zou\BannerSlider\Helper;
...
use Zou\BannerSlider\Model\Config\Source\Effect;
...
/**
 * Class Data
 * @package Zou\BannerSlider\Helper
 */
class Data extends AbstractData
{
    ...
    public function getBannerCollection($id = null)
    {
        ...
        $collection->join(
            ['banner_slider' => $collection->getTable('zou_bannerslider_banner_slider')],
    ...
    /**
     * @return \Zou\BannerSlider\Model\ResourceModel\Slider\Collection
     * @throws NoSuchEntityException
     */
    public function getActiveSliders()
    {
        /** @var \Zou\BannerSlider\Model\ResourceModel\Slider\Collection $collection */

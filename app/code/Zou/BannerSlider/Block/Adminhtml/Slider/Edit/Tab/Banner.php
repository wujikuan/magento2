...
namespace Zou\BannerSlider\Block\Adminhtml\Slider\Edit\Tab;
...
use Zou\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\GridImage;
use Zou\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Status;
use Zou\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Type;
use Zou\BannerSlider\Model\BannerFactory;
use Zou\BannerSlider\Model\ResourceModel\Banner\Collection;
use Zou\BannerSlider\Model\ResourceModel\Banner\CollectionFactory as BannerCollectionFactory;

/**
 * Class Banner
 * @package Zou\BannerSlider\Block\Adminhtml\Slider\Edit\Tab
 */
class Banner extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('zou_bannerslider_banner_slider')],
    ...
    /**
     * @param \Zou\BannerSlider\Model\Banner|Object $item
     *
     * @return string
     */
